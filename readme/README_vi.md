...
> Bản README tiếng Việt cho fork [`theitm/PaddleOCR`](https://github.com/theitm/PaddleOCR). Dự án gốc: [`PaddlePaddle/PaddleOCR`](https://github.com/PaddlePaddle/PaddleOCR).
